...
import { CalendarCheck, HardHat, ArrowLeft } from "lucide-react"
    ...
    <div className="flex flex-col items-center justify-center min-h-[70vh] space-y-8 animate-in fade-in duration-700">
      <div className="flex flex-col items-center text-center gap-4">
        <div className="relative">
          ...
          <div className="absolute -bottom-2 -right-2 bg-amber-500 p-2 rounded-lg border-2 border-background animate-bounce">
            <HardHat className="h-6 w-6 text-white" />
          </div>
        </div>
        
        <div className="space-y-2">
          <h2 className="text-3xl font-black uppercase tracking-tighter text-slate-900 leading-tight">Módulo de Frequência</h2>
          <p className="text-muted-foreground uppercase text-[10px] font-bold tracking-widest max-w-xs mx-auto">
            ESTA PÁGINA ESTÁ SENDO DESENVOLVIDA PARA INTEGRAR OS DADOS OPERACIONAIS E ESTRATÉGICOS DA UNIDADE.
          </p>
        </div>
      </div>
        ...
        <CardContent className="p-8 text-center space-y-6">
          <div className="bg-white p-4 rounded-2xl border shadow-sm">
            <p className="text-xs font-bold uppercase text-slate-600 leading-relaxed">
              EM BREVE: CONSULTA CONSOLIDADA DE PRESENÇA, MAPA DE DISTRIBUIÇÃO DE EFETIVO E AUDITORIA DE FREQUÊNCIA EM TEMPO REAL.
            </p>
          </div>
